...
data2 <- read.csv("https://raw.githubusercontent.com/joachim-gassen/oss_mame/master/raw_data/exam_data/mame_exam_2_raw_data.csv?token=AfnCvVn82FSUp6QX3ENAyMfxr7KIz3TZks5aIF27wA%3D%3D" , sep=";", dec= ",", na.strings="", nrows = 100)
data2
getwd()
